...
// More permissive config for sanitized SVG diagrams (Mermaid/PlantUML/etc.) in preview.
// We must retain inline styles and <style> tags generated by renderers/Kroki to avoid
// broken visuals (e.g., black boxes, missing strokes/markers).
export const DIAGRAM_DOMPURIFY_CONFIG = Object.freeze({
  FORBID_ATTR: ['contenteditable'],
  // Allow data-* attributes and inline styles/classes/ids used by SVG renderers
  ALLOW_DATA_ATTR: true,
  ADD_TAGS: ['style', 'foreignObject'],
  // Keep common SVG attributes and styling related attributes so diagrams render correctly
  ADD_ATTR: [
    'style', 'class', 'id',
    'viewBox', 'preserveAspectRatio', 'transform',
    'xmlns', 'xmlns:xlink', 'xml:space', 'xlink:href',
    // Positioning and text attributes
    'x', 'y', 'dx', 'dy', 'text-anchor', 'dominant-baseline', 'alignment-baseline',
    // Shape/geometry attributes commonly used
    'd', 'points', 'r', 'cx', 'cy',
    // Accessibility attributes often emitted by renderers
    'role', 'aria-label', 'aria-hidden',
    // Marker/defs and styling helpers frequently used by Mermaid/PlantUML
    ...
    'fill', 'fill-opacity', 'stop-color', 'offset',
    // Fonts
